      ...
      case (members, _) =>
        ...
        val instanceDefs = repr.instances.map(_.encoder).map {
          case instance @ Instance(_, instanceType, instanceName) =>
            q"""
              val $instanceName: _root_.ngthanhtrung.scalajs.noton.Encoder[$instanceType] =
                ${instance.resolve()}
            """
        }
        ...
        c.Expr[Encoder[A]](
          q"""
            _root_.ngthanhtrung.scalajs.noton.Encoder.instance { a =>
              ..$instanceDefs
    ...
    membersFromPrimaryCtor(tpe, rawRequired = true).fold(
      ...
      case (members, _) =>
        ...
        val instanceDefs = repr.instances.map(_.decoder).map {
          case instance @ Instance(_, instanceType, instanceName) =>
            q"""
              val $instanceName: _root_.ngthanhtrung.scalajs.noton.Decoder[$instanceType] =
                ${instance.resolve()}
            """
        }
        ...
        val body = membersWithNames.reverse.foldLeft[Tree](
          q"""
            ...
            ): _root_.ngthanhtrung.scalajs.noton.Decoder.Result[$tpe]
          """
        ) {
          case (accumulated, (Member(_, memberDecodedName, memberType), memberResultName)) =>
            ...
            q"""
              val $resultName: _root_.ngthanhtrung.scalajs.noton.Decoder.Result[$memberType] =
              ...
              if ($resultName.isRight) {
                ...
                $resultName.asInstanceOf[_root_.ngthanhtrung.scalajs.noton.Decoder.Result[$tpe]]
              }
            """
        }
        ...
        c.Expr[Decoder[A]](
          q"""
            _root_.ngthanhtrung.scalajs.noton.Decoder.instance { any =>
